...
cost_per_patient_post_yr1 <- 25.64
...
scales::dollar(net_benefits_1A) # $3,107,796
...
Baseline2A_overall - Intervention2A_overall
...
Baseline2A_overall # $16,054,401, NOTE THIS IS SAME AS 1A BASELINE OBV
Intervention2A_overall # $14,188,735
...
Intervention2B_overall # $15,121,568
